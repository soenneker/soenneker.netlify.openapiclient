...
using Soenneker.Netlify.OpenApiClient.Sites.Item.Files.Item;
...
namespace Soenneker.Netlify.OpenApiClient.Sites.Item.Files
{
    ...
    public partial class FilesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Netlify.OpenApiClient.Sites.Item.Files.FilesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::Soenneker.Netlify.OpenApiClient.Models.FileObject>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.Netlify.OpenApiClient.Models.FileObject>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.Netlify.OpenApiClient.Models.FileObject>(requestInfo, global::Soenneker.Netlify.OpenApiClient.Models.FileObject.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Netlify.OpenApiClient.Sites.Item.Files.FilesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Netlify.OpenApiClient.Sites.Item.Files.FilesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Netlify.OpenApiClient.Sites.Item.Files.FilesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
